...
classes = ['pedestrian', 'people', 'bicycle', 'car', 'van', 'truck', 'tricycle', 'awning-tricycle', 'bus', 'motor']  # 这里改一下

parser = argparse.ArgumentParser()
parser.add_argument('--image_path', default=r'E:\cbd\ICCV\datasets\VisDrone\test\images', type=str, help="path of images")  # 图片路径改一下
parser.add_argument('--label_path', default=r'E:\cbd\ICCV\datasets\VisDrone\test\labels', type=str, help="path of labels .txt")  # 图片标签路径改一下
parser.add_argument('--save_path', type=str, default='test.json',   # 数据的json格式
